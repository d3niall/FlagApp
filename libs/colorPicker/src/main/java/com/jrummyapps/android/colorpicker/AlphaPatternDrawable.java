 ...
 * It's the pattern you will often see as a background behind a partly transparent image in many
 * applications.
 */
class AlphaPatternDrawable extends Drawable {
     ...
     * Because recreating the pattern i rather expensive. I will only be recreated if the size
     * changes.
     */
