...
public class ColorPickerDialog extends DialogFragment implements OnTouchListener, OnColorChangedListener, TextWatcher {
     ...
     * Set the callback
     *
     * @param colorPickerDialogListener The callback invoked when a color is selected or the dialog
     *                                  is dismissed.
     */
    ...
    View createPickerView() {
        ...
        ImageView arrowDown = (ImageView) contentView.findViewById(R.id.cpv_arrow_down);
        ...
        try {
            ...
            typedArray.recycle();
            arrowDown.setColorFilter(arrowColor);
    ...
    public static final class Builder {
         ...
         *
         * @param showAlphaSlider {@code true} to show the alpha slider. Currently only supported
         *                        with the {@link ColorPickerView}.
         * @return This builder object for chaining method calls
         */
